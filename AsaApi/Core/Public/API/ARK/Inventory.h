...
struct UPrimalInventoryComponent : UActorComponent
{
    ...
    // modified
    APrimalStructureItemContainer* BPCreateDropItemInventoryEmpty(double DestroyAtTime, TSubclassOf<APrimalStructureItemContainer>* OverrideInventoryDepositClass, APrimalStructureItemContainer* CopyStructureValues, AActor* GroundIgnoreActor, int DeadPlayerID, float DropInventoryOnGroundTraceDistance, bool bOverrideDepositLocation, const UE::Math::TVector<double>& DepositLocationOverride) { return NativeCall<APrimalStructureItemContainer*, double, TSubclassOf<APrimalStructureItemContainer>*, APrimalStructureItemContainer*, AActor*, int, float, bool, const UE::Math::TVector<double>&>(this, "UPrimalInventoryComponent.BPCreateDropItemInventoryEmpty(double,TSubclassOf<APrimalStructureItemContainer>,APrimalStructureItemContainer*,AActor*,int,float,bool,UE::Math::TVector<double>&)", DestroyAtTime, OverrideInventoryDepositClass, CopyStructureValues, GroundIgnoreActor, DeadPlayerID, DropInventoryOnGroundTraceDistance, bOverrideDepositLocation, DepositLocationOverride); }
